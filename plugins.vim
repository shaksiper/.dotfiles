...
"Plug 'sindrets/winshift.nvim' " may not be useful for us?
...
"Plug 'klen/nvim-config-local' " May or may not be very useful for us
...
"Plug 'anuvyklack/hydra.nvim' " I could not find a use for this
