...
vim.keymap.set("n", "<leader>dr", function() require("dap-view").show_view("repl") end, { desc = "DAP REPL" })
vim.keymap.set("n", "<leader>dW", function() require("dap-view").show_view("watches") end, { desc = "DAP REPL" })
vim.keymap.set("n", "<leader>dw", function() require("dap-view").add_expr() end, { desc = "DAP Add expr" })
vim.keymap.set("n", "<leader>dt", function() require("dap-view").toggle(true) end, { desc = "DAP Toggle UI" })
