	...
	textobjects = {
		select = {
			...
			keymaps = {
				...
				["ar"] = { query = "@returns", desc = "Select return type" },
				-- ["iO"] = { query = "@comment.outer", desc = "Select inside comment" },
		...
		move = {
			...
			goto_next_start = {
				...
				["]r"] = { query = "@returns", desc = "Move to return types" },
			},
			goto_next_end = {
...
--
-- -- TODO : unify this behavior and abstract it from this
-- -- perhaps with this : https://github.com/mawkler/demicolon.nvim or https://github.com/ghostbuster91/nvim-next
